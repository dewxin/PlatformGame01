...
public sealed class GUIStyleExample : EditorWindow
{
    ...
    [MenuItem("Tools/Example/GUIStyleExmaple")]
    private static void GUIStyleExmaple()
    {

        GetWindow<GUIStyleExample>(true);
    }
