...
namespace UnityEditor.U2D
{
    static internal class MenuItems
    {
        ...
        {
            ItemCreationUtility.CreateAssetObjectFromTemplate<Texture2D>("Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/ObjectMenuCreation/DefaultAssets/Textures/v2/Triangle.png");
        }
        ...
        {
            ItemCreationUtility.CreateAssetObjectFromTemplate<Texture2D>("Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/ObjectMenuCreation/DefaultAssets/Textures/v2/Square.png");
        }
        ...
        {
            ItemCreationUtility.CreateAssetObjectFromTemplate<Texture2D>("Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/ObjectMenuCreation/DefaultAssets/Textures/v2/Circle.png");
        }
        ...
        {
            ItemCreationUtility.CreateAssetObjectFromTemplate<Texture2D>("Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/ObjectMenuCreation/DefaultAssets/Textures/v2/Capsule.png");
        }
        ...
        {
            ItemCreationUtility.CreateAssetObjectFromTemplate<Texture2D>("Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/ObjectMenuCreation/DefaultAssets/Textures/v2/IsometricDiamond.png");
        }
        ...
        {
            ItemCreationUtility.CreateAssetObjectFromTemplate<Texture2D>("Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/ObjectMenuCreation/DefaultAssets/Textures/v2/HexagonFlatTop.png");
        }
        ...
        {
            ItemCreationUtility.CreateAssetObjectFromTemplate<Texture2D>("Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/ObjectMenuCreation/DefaultAssets/Textures/v2/HexagonPointedTop.png");
        }
        ...
        {
            ItemCreationUtility.CreateAssetObjectFromTemplate<Texture2D>("Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/ObjectMenuCreation/DefaultAssets/Textures/v2/9Sliced.png");
        }
        ...
        {
            CreateSpriteRendererGameObject("Triangle", "Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/ObjectMenuCreation/DefaultAssets/Textures/v2/Triangle.png", menuCommand);
        }
        ...
        {
            CreateSpriteRendererGameObject("Square", "Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/ObjectMenuCreation/DefaultAssets/Textures/v2/Square.png", menuCommand);
        }
        ...
        {
            CreateSpriteRendererGameObject("Circle", "Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/ObjectMenuCreation/DefaultAssets/Textures/v2/Circle.png", menuCommand);
        }
        ...
        {
            CreateSpriteRendererGameObject("Capsule", "Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/ObjectMenuCreation/DefaultAssets/Textures/v2/Capsule.png", menuCommand);
        }
        ...
        {
            CreateSpriteRendererGameObject("Isometric Diamond", "Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/ObjectMenuCreation/DefaultAssets/Textures/v2/IsometricDiamond.png", menuCommand);
        }
        ...
        {
            CreateSpriteRendererGameObject("Hexagon Flat-Top", "Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/ObjectMenuCreation/DefaultAssets/Textures/v2/HexagonFlatTop.png", menuCommand);
        }
        ...
        {
            CreateSpriteRendererGameObject("Hexagon Pointed-Top", "Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/ObjectMenuCreation/DefaultAssets/Textures/v2/HexagonPointedTop.png", menuCommand);
        }
        ...
        {
            var go = CreateSpriteRendererGameObject("9-Sliced", "Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/ObjectMenuCreation/DefaultAssets/Textures/v2/9Sliced.png", menuCommand);
            var sr = go.GetComponent<SpriteRenderer>();
        ...
        static void GameObjectCreatePhysicsStaticSprite(MenuCommand menuCommand)
        {
            ...
            if (sr.sprite == null)
                sr.sprite = AssetDatabase.LoadAssetAtPath<Sprite>(
                    "Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/ObjectMenuCreation/DefaultAssets/Textures/v2/Square.png");
        ...
        static void GameObjectCreatePhysicsDynamicSprite(MenuCommand menuCommand)
        {
            ...
            if (sr.sprite == null)
                sr.sprite = AssetDatabase.LoadAssetAtPath<Sprite>(
                    "Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/ObjectMenuCreation/DefaultAssets/Textures/v2/Circle.png");
            var rigidBody = go.GetComponent<Rigidbody2D>();
        ...
        static void GameObjectCreateSpriteMask(MenuCommand menuCommand)
        {
            ...
            go.GetComponent<SpriteMask>().sprite = AssetDatabase.LoadAssetAtPath<Sprite>(
                "Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/ObjectMenuCreation/DefaultAssets/Textures/CircleMask.png");
        }
    }
}
