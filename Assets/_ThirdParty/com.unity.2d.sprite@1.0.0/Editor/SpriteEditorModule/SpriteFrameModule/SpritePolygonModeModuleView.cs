...
namespace UnityEditor.U2D.Sprites
{
    internal partial class SpritePolygonModeModule : SpriteFrameModuleBase
    {
        ...
        {
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/UI/SpriteEditor/PolygonChangeShapeWindow.uxml") as VisualTreeAsset;
