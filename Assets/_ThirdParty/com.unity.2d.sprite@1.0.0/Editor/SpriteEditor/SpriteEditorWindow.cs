...
namespace UnityEditor.U2D.Sprites
{
    ...
    public class SpriteDataProviderFactories
    {
        ...
        internal string GetAssetPath(UnityEngine.Object obj)
        {
            ...
            ///<see cref="TextureImporterDataProviderFactory"/>
    ...
    internal class SpriteEditorWindow : SpriteUtilityWindow, ISpriteEditor
    {
        ...
        private class SpriteEditorWindowStyles
        {
            ...
            public static readonly string styleSheetPath = "Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/UI/SpriteEditor/SpriteEditor.uss";
        }
        ...
        void OnEnable()
        {
            ...
            titleContent = EditorGUIUtility.TrTextContentWithIcon(L10n.Tr("Sprite Editor"), "Assets/_ThirdParty/com.unity.2d.sprite@1.0.0/Editor/Assets/SpriteEditor.png");
            selectedObject = Selection.activeObject;
