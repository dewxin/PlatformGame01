...
namespace WildBoarEditor.UI
{
    ...
    public class ScrollRectEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_HorizontalScrollbar.objectReferenceValue!=null && !m_HorizontalScrollbar.hasMultipleDifferentValues)
            {
                EditorGUI.indentLevel++;
            ...
            if (m_VerticalScrollbar.objectReferenceValue != null && !m_VerticalScrollbar.hasMultipleDifferentValues)
            {
                EditorGUI.indentLevel++;
