...
namespace WildBoarEditor.UI
{
    ...
    static internal class MenuOptions
    {
        ...
        [MenuItem("GameObject/WildBoar/UI/Image", false, (int)MenuOptionsPriorityOrder.Image)]
        ...
        [MenuItem("GameObject/WildBoar/UI/Raw Image", false, (int)MenuOptionsPriorityOrder.RawImage)]
        ...
        [MenuItem("GameObject/WildBoar/UI/Panel", false, (int)MenuOptionsPriorityOrder.Panel)]
        ...
        [MenuItem("GameObject/WildBoar/UI/Toggle", false, (int)MenuOptionsPriorityOrder.Toggle)]
        ...
        [MenuItem("GameObject/WildBoar/UI/Slider", false, (int)MenuOptionsPriorityOrder.Slider)]
        ...
        [MenuItem("GameObject/WildBoar/UI/Scrollbar", false, (int)MenuOptionsPriorityOrder.Scrollbar)]
        ...
        [MenuItem("GameObject/WildBoar/UI/Scroll View", false, (int)MenuOptionsPriorityOrder.ScrollView)]
        ...
        [MenuItem("GameObject/WildBoar/UI/Canvas", false, (int)MenuOptionsPriorityOrder.Canvas)]
        ...
        [MenuItem("GameObject/WildBoar/UI/Legacy/Text", false, (int)MenuOptionsPriorityOrder.Text)]
        ...
        [MenuItem("GameObject/WildBoar/UI/Legacy/Button", false, (int)MenuOptionsPriorityOrder.Button)]
        ...
        [MenuItem("GameObject/WildBoar/UI/Legacy/Dropdown", false, (int)MenuOptionsPriorityOrder.Dropdown)]
        ...
        [MenuItem("GameObject/WildBoar/UI/Legacy/Input Field", false, (int)MenuOptionsPriorityOrder.InputField)]
        ...
        [MenuItem("GameObject/WildBoar/UI/Event System", false, (int)MenuOptionsPriorityOrder.EventSystem)]
