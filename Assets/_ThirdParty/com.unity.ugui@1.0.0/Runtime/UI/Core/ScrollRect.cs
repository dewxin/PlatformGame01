...
namespace WildBoar.UI
{
    ...
    public class ScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        ...
        void UpdateCachedData()
        {
            ...
            bool hScrollbarIsChild = (m_HorizontalScrollbarRect == null || m_HorizontalScrollbarRect.parent == transform);
            bool vScrollbarIsChild = (m_VerticalScrollbarRect == null || m_VerticalScrollbarRect.parent == transform);
            bool allAreChildren = (viewIsChild && hScrollbarIsChild && vScrollbarIsChild);

            m_HSliderExpand = allAreChildren && m_HorizontalScrollbarRect != null && horizontalScrollbarVisibility == ScrollbarVisibility.AutoHideAndExpandViewport;
            m_VSliderExpand = allAreChildren && m_VerticalScrollbarRect != null && verticalScrollbarVisibility == ScrollbarVisibility.AutoHideAndExpandViewport;
        ...
        protected override void OnEnable()
        {
            ...
            if (m_Horizontal && m_HorizontalScrollbar!=null)
                m_HorizontalScrollbar.onValueChanged.AddListener(SetHorizontalNormalizedPosition);
            if (m_Vertical && m_VerticalScrollbar!=null)
                m_VerticalScrollbar.onValueChanged.AddListener(SetVerticalNormalizedPosition);
        ...
        /// using UnityEngine;
        /// using System.Collections;
        /// using WildBoar.EventSystems; // Required when using event data
        ///
        ...
        {
            if (m_VSliderExpand && m_HorizontalScrollbar != null)
            {
            ...
            if (m_HSliderExpand && m_VerticalScrollbar != null)
            {
