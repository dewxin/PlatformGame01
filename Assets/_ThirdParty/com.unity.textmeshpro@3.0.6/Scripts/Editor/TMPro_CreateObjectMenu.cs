...
namespace TMPro.EditorUtilities
{
    public static class TMPro_CreateObjectMenu
    {
        ...
        /// </summary>
        /// <param name="command"></param>
        [MenuItem("GameObject/WildBoar/UI/Text - TextMeshPro", false, 2001)]
        ...
        [MenuItem("GameObject/WildBoar/UI/Button - TextMeshPro", false, 2031)]
        ...
        [MenuItem("GameObject/WildBoar/UI/Input Field - TextMeshPro", false, 2037)]
        ...
        [MenuItem("GameObject/WildBoar/UI/Dropdown - TextMeshPro", false, 2036)]
